    ...
    <div class="container mx-auto flex flex-col md:flex-row justify-center my-12 md:my-24">
        <div class="w-full lg:w-1/2">
            <div class="w-full flex justify-center lg:w-1/2 lg:ml-40">
                ...
                <img :src="data?.getAnime.cover" class="rounded-none lg:rounded-lg shadow-2xl" />
            </div>
            ...
            <p class="leading-normal mb-4 text-lg text-justify">{{ data?.getAnime.description }}</p>
            <button class="favorite" :disabled="data?.getAnime.favorite" @click="addfavorite">Add favorite</button>
        </div>
    </div>
</template>
