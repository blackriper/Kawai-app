<template>
    <div class="grid grid-row-1 justify-items-center">
        <h1 class="font-bold text-center text-xl text-purple-500 mt-10"> New Anime</h1>
...
import { NEWANIME } from '../../types/querys'
...
export default defineComponent({
    setup() {
        ...
        const { execute } = useMutation(NEWANIME);
        ...
        const handlesubmit = () => {
            ...
            execute(variables)
            alert(`New Anime added correctly`)
        }
